  ...
  template: `
    <section class="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
      ...
      <div class="relative z-10 max-w-6xl mx-auto px-6 text-center">
        ...
        <h1 class="text-7xl md:text-9xl font-black mb-8 tracking-tighter leading-[0.85] opacity-0 animate-fade-in-up [animation-delay:0.2s]">
          Mastery in <br>
        ...
        <p class="text-xl md:text-2xl opacity-60 mb-12 max-w-3xl mx-auto leading-relaxed opacity-0 animate-fade-in-up [animation-delay:0.4s]">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-6 opacity-0 animate-fade-in-up [animation-delay:0.6s]">
